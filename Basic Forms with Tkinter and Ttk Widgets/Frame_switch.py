...
class tkinterApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, Page1, Page2):
            self.frames[F] = F(container, self)#Creates istances of pages with the 
            #parent arg being the container and the controller arg being self (this class)
            #this is used to later call controller.show_frame
